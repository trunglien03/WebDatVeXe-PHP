...
<html  ng-app='myFrontend'>
   <head>
      ...
      <title>True Bus :Print Ticket/SMS | Online Bus Ticket Booking, Book Volvo AC Bus Tickets, Reservation</title>
...
data-parsley-minlength="3" data-parsley-maxlength="15" placeholder="Mobile">
  ...
  <div class="row" style="min-height:250px;margin-top:136px;">
		 ...
		 <div class="loader" style="text-align: center; display: none;"></div><!--list-BAR-->
         <div class="container">
            <div class="rb_list">
               <div class="row">
                  <div class="wrapper">
