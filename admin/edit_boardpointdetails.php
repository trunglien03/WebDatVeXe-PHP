                  ...
                  <div class="box-body">                 
                     <div class="col-md-6">
						...
						<div class="form-group">
                           <label>Bus Name</label>
							<select tabindex="1"  class="form-control select2"  style="width: 100%;" id="bus_details" name="bus_id">
								   	         ...
								   	         <option selected value="3"> Volvo</option>
								                               </select>
                        </div>
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input tabindex="3" type="text" class="form-control required" name="pickup_point" value="Vilanova de Bellpuig" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           ...
                           <input tabindex="5" type="text" class="form-control required" value="fdasfda" name="landmark" placeholder="Landmark">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
	                     ...
	                     <div class="form-group">
                          <label>Route</label>
							<select tabindex="2"  class="form-control select2 subcat" placeholder="Board point"  style="width: 100%;" name="board_point">
								   								   ...
								   								   <option selected value="4">Arbeca</option>
								                               </select>
                        </div>
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input tabindex="4" type="text" value="10:15 AM" name="pickup_time" class="form-control timepicker">
						  ...
						  <div class="form-group has-feedback">
                           ...
                           <input tabindex="6"  type="text" class="form-control required" value="fdsafdas" name="address" placeholder="Address">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
				   </div>
