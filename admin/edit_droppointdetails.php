                  ...
                  <div class="box-body">                 
                     <div class="col-md-6">					   
					    ...
					    <div class="form-group has-feedback">
                           ...
                           <input tabindex="2"  type="text" class="form-control required" name="stoping_point" value="Aluva" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
                           ...
                           <input tabindex="5"  type="text" class="form-control required" value="test" name="landmark" placeholder="Landmark">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                          ...
                          <label>Route</label>
							<select tabindex="2" name="drop_point" class="form-control select2 subcats" style="width: 100%;">
							 								   <option  value="3">Kochi</option>
								   								   <option  value="4">Bellpuig</option>
								   							</select>
                        </div>
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input tabindex="4"  type="text" value="06:00 AM" name="drop_time" class="form-control timepicker">
						  ...
						  <div class="form-group has-feedback">
                           ...
                           <input tabindex="6" type="text" class="form-control required" value="test" name="address" placeholder="Address">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
				   </div>
