                     ...
                     <div class="col-md-6">
					      ...
					      <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Bus Name</label>
                            <input  tabindex="1" type="text" class="form-control required" value="Volvo XL" data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
						   ...
						   value="Banglore" data-parsley-trigger="change"	
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input  tabindex="7" type="text" name="board_time" value="02:30 PM" class="form-control timepicker">
                        ...
                        <label>Amenities</label>
							<select tabindex="9"  class="form-control select2 js-example-basic-multiple"  multiple="multiple" style="width: 100%;" name="amenities_id[]" id="amenities">
								   			            ...
								   			            <option value="5" >Charging Point</option>			  
								   			            <option value="6"selected >Movie</option>			  
								   			            <option value="7" >Reading Light</option>			  
								   			            <option value="8" >Pillow</option>			  
								   			            <option value="9" >Personal TV</option>			  
								   			            <option value="10" >Track My Bus</option>			  
								   			            <option value="11" >Emergency exit</option>			  
								   			            <option value="12" >Fire Extinguisher</option>			  
								   			            <option value="13" >Hammer (to break glass)</option>			  
								   			            <option value="14" >Emergency Contact Number</option>			  
								                               </select>
                       </div>	                 			   
                  ...
                  <div class="box-footer">
				   ...
				   <div class="col-md-6">
				        ...
				        <div class="form-group has-feedback">
                           ...
                           <input  tabindex="2" type="text" class="form-control required" name="bus_reg_no" value="2563"data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Bus RegiNumber">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						 <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Maximum Seats</label>
                           <input tabindex="4" type="text" class="form-control required" name="max_seats" value="40"
                           ...
                           <input tabindex="6"  type="text" class="form-control required" name="drop_point" value="Chennai"data-parsley-trigger="change"	data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="End Point">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						  ...
						  <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input tabindex="8" type="text" name="drop_time" value="07:30 PM" class="form-control timepicker">
								<div class="input-group-addon">
								  <i class="fa fa-clock-o"></i>
								</div>
							  </div><!-- /.input group -->
