              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
				 ...
				 <div class="col-md-6">
                                    ...
                                    <input tabindex="1" class="form-control required regcom" type="text" name="title" data-parsley-trigger="keyup" required="" id="smtp_username" value="True Bus">
                                    </div>
										
								    <div class="form-group">
                                    <label class="intrate">Smtp Username</label>
                                    <input tabindex="3"class="form-control required regcom" type="text" name="smtp_username" data-parsley-trigger="keyup" required="" id="smtp_username" value="truebus">
                                    </div>	
                                    
									<div class="form-group">
                                    <label  class="intrate">Smtp Host</label>
                                    <input tabindex="5"	class="form-control regcom required" type="text" name="smtp_host" data-parsley-trigger="keyup" required="" id="smtp_host" value="truebushost" >
                                    </div>
									   <div class="form-group">
									   <label class="intrate">Smtp Password</label>
									   <input tabindex="7"class="form-control regcom required" type="text" name="smtp_password" data-parsley-trigger="keyup" required="" id="smtp_password" value="Golden_123" >
									   </div>
										
								   <div class="form-group">
                                   <label class="intrate">Sender Id</label>
                                   <input tabindex="9" class="form-control regcom required" type="text" name="sender_id" data-parsley-trigger="keyup" required="" id="smtp_password" value="101">
                                   </div>
								   
								    <div class="form-group">
								   <label class="intrate">Sms username</label>
								   <input tabindex="11"class="form-control regcom required" type="text" name="sms_username" data-parsley-trigger="keyup" required="" id="sms_username" value="manu">
								   </div>
                     ...
                     <div class="form-group">
				        ...
				        <div class="col-md-6">
								   ...
								   <div class="form-group">
									...
									<input tabindex="2" class="form-control regcom required" type="text" name="sms_password" data-parsley-trigger="keyup" required="" id="sms_password" value="676">
								   </div>

								   <div class="form-group">
                                    <label  class="intrate">App Key</label>
                                    <input tabindex="4" class="form-control regcom required" type="text" name="app_key" data-parsley-trigger="keyup" required="" id="app_key" value="my_key" >
                                   </div>
                                   <div class="form-group">
										
                                            
		                        <label>Payment option</label><br>
		                        <input tabindex="6"type="checkbox" name="payment_option[]" value="PayPal" checked> PayPal<br>
		                        <input  type="checkbox" name="payment_option[]" value="Cash"  checked> Cash<br>
		                         </div> 
								   ...
								   <img src="http://demo.truebus.co.in/admin/assets/uploads/logo/1544094363_tb-logo.png" width="100px" height="100px" alt="Picture Not Found"/>
								   </div>							   
								   
								   <div class="form-group has-feedback">
								   <label for="exampleInputEmail1">Favicon</label>
								   <input tabindex="10" name="favicon"  type="file" class="">
								   <img src="http://demo.truebus.co.in/admin/assets/uploads/favicons/1495099426_bus1.jpg" width="25px" height="25px" alt="Picture Not Found"/>
								   </div>							 		 
		                </div>
