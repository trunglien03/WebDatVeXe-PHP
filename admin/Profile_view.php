...
<div class="user-profile-pic">
    <div class="user_pic">
        <img class="profile-user-img img-responsive img-circle" src="http://techlabz.in/truebusupdate/admin/assets/uploads/profile_pic/admin/1511772739_man.png">
            </div>
        ...
        <div class="uploadFile">
            <form method="post" id="profilepic-form-img" enctype="multipart/form-data">
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <form role="form" action="http://demo.truebus.co.in/admin/Admin_detailsview/Admin_change_password" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
