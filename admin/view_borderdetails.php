...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
        View Boarding Point Details
      </h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-hand-o-up"></i>Home</a></li>
         <li><a href="#">Boarding Details</a></li>
         <li class="active">View Boarding point</li>
      </ol>
   </section>
   <!-- Main content -->
               ...
               <div class="box-body">
                  <table id="" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
                           ...
                           <td class="center">KMN</td>                                                 
                           <td class="center">kochi</td>                                                 
                           <td class="center">vytilla</td>                         
                           <td class="center">10:15 AM</td> 
						   <td class="center">d</td>   
                           <td class="center">sddfff</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-boardgetdetails" href="javascript:void(0);" data-id="1">
                              <i class="fa fa-fw fa-eye"></i> View </a>
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Borderpoint_details/edit_boardpointdetails/1">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Borderpoint_details/delete_boardpoint/1" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                                <tr>
                           <td class="hidden">2</td>
                           <td class="center">MNT</td>                                                 
                           <td class="center">munnar</td>                                                 
                           <td class="center">adimali</td>                         
                           <td class="center">10:15 AM</td> 
						   <td class="center">asd</td>   
                           <td class="center">sdf</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-boardgetdetails" href="javascript:void(0);" data-id="2">
                              <i class="fa fa-fw fa-eye"></i> View </a>
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Borderpoint_details/edit_boardpointdetails/2">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Borderpoint_details/delete_boardpoint/2" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                                <tr>
                           <td class="hidden">3</td>
                           <td class="center">Volvo</td>                                                 
                           <td class="center">Bangalore</td>                                                 
                           <td class="center">madivala</td>                         
                           <td class="center">03:00 PM</td> 
						   <td class="center">test</td>   
                           <td class="center">test</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-boardgetdetails" href="javascript:void(0);" data-id="3">
                              <i class="fa fa-fw fa-eye"></i> View </a>
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Borderpoint_details/edit_boardpointdetails/3">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Borderpoint_details/delete_boardpoint/3" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                                <tr>
                           ...
                           <td class="center">Volvo</td>                                                 
                           <td class="center">Arbeca</td>                                                 
                           <td class="center">Vilanova de Bellpuig</td>                         
                           <td class="center">10:15 AM</td> 
						   <td class="center">fdasfda</td>   
                           <td class="center">fdsafdas</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-boardgetdetails" href="javascript:void(0);" data-id="4">
                              <i class="fa fa-fw fa-eye"></i> View </a>
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Borderpoint_details/edit_boardpointdetails/4">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Borderpoint_details/delete_boardpoint/4" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                             </tbody>
