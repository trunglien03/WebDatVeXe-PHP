               ...
               <div class="box-body">
                  <table id="" class="table table-bordered table-striped datatable">
                     ...
                     <tbody>
						   ...
						   <td class="center">xzfcgg</td>   
                           <td class="center">fg</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-dropgetdetails" href="javascript:void(0);" data-id="1">
                              <i class="fa fa-fw fa-eye"></i> View </a>	
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Droppoint_details/edit_droppointdetails/1">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Droppoint_details/delete_droppoint/1" onClick="return doconfirm()">
                           ...
                           <td class="center">10:15 AM</td> 
						   <td class="center">sdff</td>   
                           <td class="center">zdf</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-dropgetdetails" href="javascript:void(0);" data-id="2">
                              <i class="fa fa-fw fa-eye"></i> View </a>	
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Droppoint_details/edit_droppointdetails/2">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Droppoint_details/delete_droppoint/2" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                                <tr>
                           ...
                           <td class="center">Kochi</td>                                                 
                           <td class="center">Aluva</td>                         
                           <td class="center">06:00 AM</td> 
						   <td class="center">test</td>   
                           <td class="center">test</td>						   
                           <td class="center">	                         
                           		  
                              <a class="btn btn-sm bg-olive show-dropgetdetails" href="javascript:void(0);" data-id="3">
                              <i class="fa fa-fw fa-eye"></i> View </a>	
                              <a class="btn btn-sm btn-primary" href="http://demo.truebus.co.in/admin/Droppoint_details/edit_droppointdetails/3">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" href="http://demo.truebus.co.in/admin/Droppoint_details/delete_droppoint/3" onClick="return doconfirm()">
                              <i class="fa fa-fw fa-trash"></i>Delete</a>							
                           </td>
                        </tr>
                                             </tbody>
